...
export const T: Record<string, Record<string, string>> = {
  ...
  welcome_customer:      { en: "Welcome {name}! Your customer account is active. Tokens: 0. Support: {contact}", sw: "Karibu {name}! Akaunti yako iko tayari. Tokens: 0. Piga: {contact}" },
  welcome_merchant:      { en: "Welcome {name}! Your merchant account is active. Share your code to earn. Support: {contact}", sw: "Karibu {name}! Akaunti ya kuuza iko tayari. Piga: {contact}" },
  ...
  delivery_confirmed:    { en: "END Delivery confirmed.\nPool limit adjusted.", sw: "END Mzigo umethibitishwa.\nPool limit adjusted." },
  ...
  enter_otp:             { en: "CON Enter the OTP sent to your phone (Demo: {OTP}):", sw: "CON Weka namba ya OTP (Demo: {OTP}):" },
